...
use Pephpit\HttpClient\Client as TestedClass;
use Pephpit\HttpClient\Method;
use Pephpit\HttpClient\MineType;
use	mageekguy\atoum;
...
nostrum rerum est autem sunt rem eveniet architecto',
		...
		$this->object($response)->isInstanceOf('\\Pephpit\HttpClient\\Response');
...
est aut tenetur dolor neque',
	...
	public function testSslVersion() {
		$client = new TestedClass('https://www.payPephpit.ch');
